...
public class FullImageViewWithTitleList extends ManagedFragmentActivity {
    ...
    public static Intent createIntent(Context context, String[] title, String imageURI, String[] imageURIs, int _position) {
        ...
        imageUris = imageURIs;
        position = _position;
        return new Intent(context, FullImageViewWithTitleList.class);
    }
...
//        ImageLoadingHandler.Display(imageUri, touch, true, false, true);
        ...
        if (imageUris != null && imageUris.length > 0) {
            ...
            mPagerAdapter = new MyPagerAdapter(getSupportFragmentManager(), imageUris, pageTitle, position);
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public MyPagerAdapter(android.support.v4.app.FragmentManager fm, String[] imagesURIs, String[] _title, int _position) {
            super(fm);
            images = imagesURIs;
            title = _title;
            position = _position;
        ...
        public android.support.v4.app.Fragment getItem(int pos) {
            return FullImageFragmentWithTitle.newInstance(images[pos], pageTitle[pos]);
        }
