...
public class LinkedinDialog extends Dialog {
    ...
    private void setWebView() {
        LinkedinDialog.oAuthService = LinkedInOAuthServiceFactory.getInstance()
                .createLinkedInOAuthService(SocialConstants.LINKEDIN_CONSUMER_KEY, SocialConstants.LINKEDIN_CONSUMER_SECRET);
        ...
        LinkedinDialog.liToken = LinkedinDialog.oAuthService
                .getOAuthRequestToken(SocialConstants.LINKEDIN_CALL_BACK_URI);
    ...
    class HelloWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if (url.contains(SocialConstants.LINKEDIN_CALL_BACK_URI)) {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        LinkedInController.activity.finish();
    }
}
