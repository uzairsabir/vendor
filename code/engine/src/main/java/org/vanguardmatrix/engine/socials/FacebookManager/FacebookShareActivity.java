...
//        try {
//            PackageInfo info = getPackageManager().getPackageInfo(getString(R.string.application_package), PackageManager.GET_SIGNATURES);
//
...
//        Intent resultIntent = new Intent(this, HomeScreenOld.class);
//
...
//        stackBuilder.addParentStack(HomeScreenOld.class);
