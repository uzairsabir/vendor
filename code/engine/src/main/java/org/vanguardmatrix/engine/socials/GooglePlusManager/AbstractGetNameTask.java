...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void> {
    ...
    protected GooglePlusController mActivity;
    public static String GOOGLE_USER_DATA = "No data";
    protected String mScope;
    protected String mEmail;
    protected int mRequest;

    public AbstractGetNameTask(GooglePlusController mActivity, String mEmail, String mScope) {
...
//
        ...
        //URL url = new URL("https://www.googleapis.com/auth/plus.profile.emails.read?access_token=" + token);
        ...
        if (sc == 200) {
            ...
            try {
                ...
                MyLogs.printinfo(" JsonObject " + profileData);
               // SocailSignedUserObject.facebookImporter(profileData, mEmail,"Google Plus");
