...
public class ProgressActivity extends RelativeLayout {
    ...
    private void setLoadingView() {
        if (loadingStateRelativeLayout == null) {
            ...
            loadingIndicatorView = (AVLoadingIndicatorView) view.findViewById(R.id.avloadingIndicatorView);


            loadingIndicatorView.getLayoutParams().width = loadingStateProgressBarWidth;
            loadingIndicatorView.getLayoutParams().height = loadingStateProgressBarHeight;
            loadingIndicatorView.requestLayout();
