 ...
 */
public class HomeSearchMainFragment extends Fragment implements View.OnClickListener {

    public static HomeSearchMainFragment fragment;
    ...
    public static Fragment newInstance(int sectionNumber,
                                       Activity _activity) {
        fragment = new HomeSearchMainFragment();
    ...
    public void loadData() {
        if (HomeMainSearchActivity.tab_pos == 0) {
