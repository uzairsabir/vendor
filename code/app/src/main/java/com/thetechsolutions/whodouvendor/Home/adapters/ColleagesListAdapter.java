...
public class ColleagesListAdapter extends ItemViewHolder<ColleagesDT> {
    ...
    public ColleagesListAdapter(View view) {
        super(view);
    }

    static int pos, positioninfo;

    public static Class<ColleagesListAdapter> newInstance(Activity _activity, int _pos) {
        activity = _activity;
        pos = _pos;
        return ColleagesListAdapter.class;
    }


    @Override
    public void onSetValues(ColleagesDT item, PositionInfo positionInfo) {
        this.item = item;
