package eu.siacs.conversation.ui.adapter;
...
import eu.siacs.conversation.entities.Message.FileParams;
                ...
                if (ConversationActivity.contactAvatar.isEmpty()) {
                    ...
                    viewHolder.contact_picture
                            .setOnClickListener(new OnClickListener() {
                                ...
                                @Override
                                public void onClick(View v) {
                                    Log.e("Friend_image ",""+ ConversationActivity.contactAvatar
                                    );
                                    UIHelper.showFullImage(activity, "Friend", ConversationActivity.contactAvatar, null, 0);
