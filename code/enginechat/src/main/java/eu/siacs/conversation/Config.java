...
public final class Config {
	...
	public static final String MAGIC_CREATE_DOMAIN = "128.199.204.214";
	public static final boolean DISALLOW_REGISTRATION_IN_UI = true; //hide the register checkbox

	public static final boolean ALLOW_NON_TLS_CONNECTIONS = true; //very dangerous. you should have a good reason to set this to true
