...
public class MagicCreateActivity extends EditAccountActivity implements TextWatcher {
...
//    }
    ...
    public void createXmppConnection(String username, String password) {
          ...
          //  mUsername.requestFocus();
           ...
           // mUsername.setError(null);
            try {
               ...
               // Toast.makeText(MagicCreateActivity.this, R.string.secure_password_generated, Toast.LENGTH_SHORT).show();
             //  EditAccountActivity accountActivity = new EditAccountActivity();
             //   registerConnection(username,password,"");
                //	Intent intent = new Intent(MagicCreateActivity.this, EditAccountActivity.class);
                //	intent.putExtra("jid", account.getJid().toBareJid().toString());
                //	intent.putExtra("init", true);
                //		intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
