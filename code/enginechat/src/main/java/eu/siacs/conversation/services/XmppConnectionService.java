...
import eu.siacs.conversation.crypto.PgpDecryptionService;
import eu.siacs.conversation.crypto.PgpEngine;
import eu.siacs.conversation.crypto.axolotl.AxolotlService;
import eu.siacs.conversation.crypto.axolotl.XmppAxolotlMessage;
import eu.siacs.conversation.entities.Account;
import eu.siacs.conversation.entities.Blockable;
import eu.siacs.conversation.entities.Bookmark;
...
import eu.siacs.conversation.entities.MucOptions;
import eu.siacs.conversation.entities.MucOptions.OnRenameListener;
import eu.siacs.conversation.entities.Presence;
import eu.siacs.conversation.entities.PresenceTemplate;
import eu.siacs.conversation.entities.Roster;
import eu.siacs.conversation.entities.ServiceDiscoveryResult;
import eu.siacs.conversation.entities.Transferable;
import eu.siacs.conversation.entities.TransferablePlaceholder;
import eu.siacs.conversation.generator.AbstractGenerator;
import eu.siacs.conversation.generator.IqGenerator;
import eu.siacs.conversation.generator.MessageGenerator;
import eu.siacs.conversation.generator.PresenceGenerator;
import eu.siacs.conversation.http.HttpConnectionManager;
import eu.siacs.conversation.parser.AbstractParser;
import eu.siacs.conversation.parser.IqParser;
import eu.siacs.conversation.parser.MessageParser;
import eu.siacs.conversation.parser.PresenceParser;
import eu.siacs.conversation.persistance.DatabaseBackend;
import eu.siacs.conversation.persistance.FileBackend;
import eu.siacs.conversation.ui.ChatPreferences;
import eu.siacs.conversation.ui.UiCallback;
import eu.siacs.conversation.utils.ConversationsFileObserver;
import eu.siacs.conversation.utils.CryptoHelper;
import eu.siacs.conversation.utils.ExceptionHelper;
import eu.siacs.conversation.utils.OnPhoneContactsLoadedListener;
import eu.siacs.conversation.utils.PRNGFixes;
import eu.siacs.conversation.utils.PhoneHelper;
import eu.siacs.conversation.utils.ReplacingSerialSingleThreadExecutor;
import eu.siacs.conversation.utils.SerialSingleThreadExecutor;
import eu.siacs.conversation.utils.Xmlns;
import eu.siacs.conversation.xml.Element;
import eu.siacs.conversation.xmpp.OnBindListener;
import eu.siacs.conversation.xmpp.OnContactStatusChanged;
import eu.siacs.conversation.xmpp.OnIqPacketReceived;
import eu.siacs.conversation.xmpp.OnKeyStatusUpdated;
import eu.siacs.conversation.xmpp.OnMessageAcknowledged;
import eu.siacs.conversation.xmpp.OnMessagePacketReceived;
import eu.siacs.conversation.xmpp.OnPresencePacketReceived;
import eu.siacs.conversation.xmpp.OnStatusChanged;
import eu.siacs.conversation.xmpp.OnUpdateBlocklist;
import eu.siacs.conversation.xmpp.PushManagementService;
import eu.siacs.conversation.xmpp.XmppConnection;
import eu.siacs.conversation.xmpp.chatstate.ChatState;
...
import eu.siacs.conversation.xmpp.jingle.JingleConnectionManager;
import eu.siacs.conversation.xmpp.jingle.OnJinglePacketReceived;
import eu.siacs.conversation.xmpp.jingle.stanzas.JinglePacket;
import eu.siacs.conversation.xmpp.pep.Avatar;
...
public class XmppConnectionService extends Service implements Serializable {
    ...
    public void sendOwnIQ(Contact contact, Account account) {

        sendIqPacket(account, IqGenerator.sendOwnIq(contact), mIqParser);
    ...
    public void pushContactToServer(final Contact contact) {
        ...
        if (sendUpdates) {
            Log.d("online_presense ", " online_presense");
