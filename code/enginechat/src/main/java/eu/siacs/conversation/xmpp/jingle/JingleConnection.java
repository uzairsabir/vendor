...
import eu.siacs.conversation.crypto.axolotl.OnMessageCreatedCallback;
...
import eu.siacs.conversation.services.AbstractConnectionManager;
...
import eu.siacs.conversation.xmpp.jingle.stanzas.Content;
import eu.siacs.conversation.xmpp.jingle.stanzas.JinglePacket;
import eu.siacs.conversation.xmpp.jingle.stanzas.Reason;
import eu.siacs.conversation.xmpp.stanzas.IqPacket;

public class JingleConnection implements Transferable,Serializable {

	private transient JingleConnectionManager mJingleConnectionManager;
	private transient XmppConnectionService mXmppConnectionService;
	...
	private transient Jid initiator;
	private transient Jid responder;
	private List<JingleCandidate> candidates = new ArrayList<>();
	private transient ConcurrentHashMap<String, JingleSocks5Transport> connections = new ConcurrentHashMap<>();

	private String transportId;
	private transient Element fileOffer;
	private transient DownloadableFile file = null;
	...
	private transient XmppAxolotlMessage mXmppAxolotlMessage;

	private transient JingleTransport transport = null;

	private transient OutputStream mFileOutputStream;
	private transient InputStream mFileInputStream;

	private transient OnIqPacketReceived responseListener = new OnIqPacketReceived() {
	...
	final transient OnFileTransmissionStatusChanged onFileTransmissionSatusChanged = new OnFileTransmissionStatusChanged() {
	...
	private transient OnProxyActivated onProxyActivated = new OnProxyActivated() {
