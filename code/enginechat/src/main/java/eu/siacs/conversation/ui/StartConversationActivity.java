...
import eu.siacs.conversation.entities.ListItem;
...
import eu.siacs.conversation.ui.adapter.ListItemAdapter;
import eu.siacs.conversation.utils.XmppUri;
...
public class StartConversationActivity extends EditAccountActivity implements OnRosterUpdate, OnUpdateBlocklist {
    ...
    public static String accountNumber, contactNumber;
    ...
    public static Intent createIntent(Activity _activity, String _accountNumber, String _contactNumber) {

        accountNumber = _accountNumber;
        contactNumber = _contactNumber;

        return new Intent(_activity, StartConversationActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        openChatDirectly(accountNumber, contactNumber);
    }
    ...
    protected void showCreateContactDialog(final String prefilledJid, final String fingerprint) {
        EnterJidDialog dialog = new EnterJidDialog(
                ...
                prefilledJid, null, fingerprint == null, "123@128.199.204.214"
        );
    ...
    public void openChatDirectly(String accountNumber, String contactNumber) {
        ...
        try {
            final Contact contact = account.getRoster().getContact(contactJid);
            if (contact.showInRoster()) {
                //    xmppConnectionService.sendOwnIQ(contact, account);
               ...
               // xmppConnectionService.reconnectAccountInBackground(account);
                ...
                // contact.addOtrFingerprint(fingerprint);
                Log.d("account_num ", " no  " + ConversationActivity.accountNumber);

                //   xmppConnectionService.logoutAndSave(true);
                //    registerConnection(ConversationActivity.accountNumber, "1234", "");
                xmppConnectionService.createContact(contact);
              // xmppConnectionService.reconnectAccountInBackground(account);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.action_create_contact) {
            ...
            return true;
        } else if (i == R.id.action_create_conference) {
