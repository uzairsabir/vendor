...
public class UIHelper {
	...
	public static String FILE_NAME = "friendName";
	...
	public static void showFullImage(Activity _activity, String _pageTitle, String url, List<String> urls, int position) {
		...
		_activity.startActivity(eu.siacs.conversation.utils.FullImageView.createIntent(_activity, _pageTitle, url, images, position));
