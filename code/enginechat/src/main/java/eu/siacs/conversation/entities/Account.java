...
public class Account extends AbstractEntity implements Serializable {
	...
	public final transient HashSet<Pair<String, String>> inProgressDiscoFetches = new HashSet<>();
	...
	protected transient JSONObject keys = new JSONObject();
	protected String avatar;
	protected String displayName = null;
	protected String hostname = null;
	protected int port = 5222;
	protected boolean online = false;
	private transient OtrService mOtrService = null;
	private transient AxolotlService axolotlService = null;
	private transient PgpDecryptionService pgpDecryptionService = null;
	private transient XmppConnection xmppConnection = null;
	private long mEndGracePeriod = 0L;
	private String otrFingerprint;
	private transient final Roster roster = new Roster(this);
