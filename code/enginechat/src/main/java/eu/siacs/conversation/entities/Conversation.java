...
public class Conversation extends AbstractEntity implements Serializable, Blockable, Comparable<Conversation> {
    ...
    private transient JSONObject attributes = new JSONObject();
    ...
    private transient Smp mSmp = new Smp();
    ...
    private transient ChatState mOutgoingChatState = Config.DEFAULT_CHATSTATE;
