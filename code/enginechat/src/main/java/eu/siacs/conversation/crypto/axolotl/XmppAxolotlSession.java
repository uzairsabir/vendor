...
public class XmppAxolotlSession implements Serializable {
	private transient final SessionCipher cipher;
	private transient final SQLiteAxolotlStore sqLiteAxolotlStore;
	private transient final AxolotlAddress remoteAddress;
